...
configuration. Tune by overriding Strategy fields below.
    ...
    python -m book.curve.fives_5s30s --synthetic  # single run, no DB
...
def synthetic_data(n: int = 1500, seed: int = 37):
    """Synthetic substitute: 5s30s explained by 5Y plus an OU residual."""
